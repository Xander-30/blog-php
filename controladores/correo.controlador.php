			...
			if(preg_match('/^[a-zA-ZáéíóúÁÉÍÓÚñÑ ]+$/', $_POST["nombreContacto"]) &&
			   ...
			   preg_match('/^[=\\$\\;\\*\\"\\?\\¿\\!\\¡\\:\\.\\,\\0-9a-zA-ZáéíóúÁÉÍÓÚñÑ ]+$/',  $_POST["mensajeContacto"])){
				...
				try {
                    ...
                    //esto es para que no necesite configurar nada ni en hosting 
				    $mail->isMail();

				    //Recipients
				    //correo de quien le envia
				    $mail->setFrom($_POST["emailContacto"], $_POST["nombreContacto"]);
				    //correo aquien les llegara esta en la base guardado
				    $mail->addAddress('hdelvalle29@gmail.com', 'Juanito Travel');     // Add a recipient
				    // $mail->addAddress('ellen@example.com');               // Name is optional
				    $mail->addReplyTo($_POST["emailContacto"], $_POST["nombreContacto"]);
				    // $mail->addCC('cc@example.com');
				    // $mail->addBCC('bcc@example.com');

				    // Attachments ---si desea adjuntar imagenes al correo
				    // $mail->addAttachment('/var/tmp/file.tar.gz');         // Add attachments
				    // $mail->addAttachment('/tmp/image.jpg', 'new.jpg');    // Optional name

				    // Content  --si dese enviar un documento html
