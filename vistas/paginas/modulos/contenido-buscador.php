...
if(isset($rutas[0])){
    /*se busca la palabra y que empieze desde 0 hasta 5 */
...
=============================================*/
/*si ruta 1 viene en camino y es numerica*/
if(isset($rutas[1]) && is_numeric($rutas[1])){

    /* entonces la pagina actual sera igual a ruta 1*/
	$paginaActual = $rutas[1];
   
	$desde = ($rutas[1] - 1)*5;
	$cantidad = 5;

    /* y le mandamos una solicitud de nuevo */
	...
	<div class="container">
		...
		<div class="row">
			...
			<?php if (count($articulos) != 0): ?>
             ...
             <!--sino encuentra coincidencias en el buscador -->
			<?php else: ?>
