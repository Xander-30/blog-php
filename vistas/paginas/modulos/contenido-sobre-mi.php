...
<div class="container-fluid bg-white">
	...
	<div class="container py-4">
		...
		<div class="row">
            ...
            <!--poniendole un formulario al lado de la imagen-->
			<h4 class="mt-lg-4 float-right">Contáctenos:</h4>

			<form method="post">
				
                <!--clase boostrand de formulario-->
				...
				<?php 
					...
					if($enviarCorreo != ""){
                      ...
                      /*se formatea los campos del formulario*/
						echo '<script>
                       ...
                       /*validacion para evitar que envien correos basura*/
