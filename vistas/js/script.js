...
OPINIONES VACÍAS
=============================================*/
/*validando las opiniones si llegan vacias*/
if($(".opiniones").html()){
...
$(".buscador").change(function(){
    /*capturo el valor del input del buscador y lo convierte a minuscula*/
	var busqueda = $(this).val().toLowerCase();
    
    /*validacion antiataques*/
